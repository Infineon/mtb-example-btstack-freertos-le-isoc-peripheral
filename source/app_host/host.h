...
#define HOST_LIST_MAX 1
#define HOST_INFO_SIZE (1 + (HOST_LIST_MAX * (BD_ADDR_LEN+1)))
 ...
 *
 ******************************************************************************/
void host_set_cccd_flags(const wiced_bt_device_address_t bdAddr,
                         uint16_t nflags, uint16_t iflags);
